...
const Banner = () => {
    return (
        <div className="banner-bg md:h-[100vh]">
            <div className='flex  flex-col md:flex-row items-center justify-center gap-8 z-10 mx-4 pt-16 pb-12'>
                ...
                <div className='z-10 rakib md:w-2/5'>
                    <img src={hero} className='z-2 w-[500px] md:w-full mt-6 ' alt="" />
                </div>
            </div>
